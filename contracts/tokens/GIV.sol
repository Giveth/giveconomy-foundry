...
contract GIV is IERC20 {
    ...
    //      keccak256("Giveth")
    bytes32 public constant NAME_HASH = 0x33ef7d8509d7fc60c9fbe6cfb57a52ac1d91ca62f595d3b55c7cbdbb6372f902;
    ...
    function _validateSignedData(address signer, bytes32 encodeData, uint8 v, bytes32 r, bytes32 s) internal view {
        ...
        require(recoveredAddress != address(0) && recoveredAddress == signer, 'GIV:INVALID_SIGNATURE');
    }
    ...
    function _transfer(address from, address to, uint256 value) private {
        require(to != address(this) && to != address(0), 'GIV:NOT_VALID_TRANSFER');
