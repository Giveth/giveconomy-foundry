...
contract TestModifyDistro is Test {
    ...
    uint256 forkBlock = 22501098;
        ...
        function setUp() public {
            ...
            // proxyAdmin.upgradeAndCall(tokenDistroProxy, address(tokenDistroImplementation), abi.encodeWithSelector(TokenDistro(tokenDistroImplementation).initialize.selector, 2000000000000000000000000000, 1640361600, 1640361600, 157680000,  givToken, true));
        ...
        function testTransferAllocation(uint256 amount1, uint256 amount2, uint256 amount3) public {
            ...
            // assertions
            assertEq(secondRecipientAllocatedTokensAfterTransfer, (firstRecipientAllocatedTokens.add(secondRecipientAllocatedTokens)));
        ...
        function testTransferAllocationWithClaim(uint256 amount1, uint256 amount2) public {
            ...
            (uint256 secondAllocatedAfterTransfer, uint256 secondClaimedAfterTransfer) = tokenDistro.balances(secondRecipient);
        ...
        //     console.log('claimable for first recipient',tokenDistro.claimableNow(firstRecipient));
        //     // vm.expectRevert("TokenDistro::claim: NOT_ENOUGH_TOKENS_TO_CLAIM");
